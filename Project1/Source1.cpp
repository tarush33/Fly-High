...
//	//glColor3f(1.0, 1.0, 1.0);
//	//Write(0.15, -0.415, 0.0, 0.0006, (char*)" 1. Ms. Sangeeta roy");
//
//	glFlush();
//}
//
...
//		renderBitmapString(30, 30, 0, GLUT_BITMAP_TIMES_ROMAN_24, "scored:");
//		renderBitmapString(60, 30, 0, GLUT_BITMAP_TIMES_ROMAN_24, scs);
//		glutSwapBuffers();
//		glFlush();
//		printf("\nGAME OVER\n\n");
...
//			bspd += 0.005;//increase block_dx_speed by 0.01 
//		}
